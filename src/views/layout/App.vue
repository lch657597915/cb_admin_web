<template>
  <div class="main">
    <div class="header">
      <div class="logo">
        <span class="big">{{ $Cfg.siteName }}</span>
        <span class="min">
          <img
            width="28"
          ...
          >
            ...
            <template v-for="(menu_v, menu_k) in menu">
              ...
              >
                ...
                <el-menu-item
                  v-auth="menuChildren_v.permissionsKey"
...
import { getUserInfo } from "@/utils/dataStorage.js";
  ...
  methods: {
    ...
    sidebarToggle(e) {
      ...
      if (this.isCollapse) {
        ...
        this.siteName = this.$Cfg.siteName;
    ...
    logout() {
      loginOut({ platform: this.$Cfg.platformUUID }).then(res => {
        localStorage.removeItem(this.$Cfg.tokenKey);
        sessionStorage.removeItem(this.$Cfg.tokenKey);
